...
public class ParticleUtils {
	...
	public static void playHelix(final Location loc, final float i, final ParticleEffect particle) {
		BukkitRunnable runnable = new BukkitRunnable() {
			...
			public void run() {
				...
				if (particle == ParticleEffect.REDSTONE)
	...
	public static void display(ParticleEffect particle, Location location, int amount) {
		particle.display(0, 0, 0, 0, amount, location, 128);
	}
	
	public static void display(ParticleEffect particle, Location location) {
